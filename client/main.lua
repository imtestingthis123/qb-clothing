...
RegisterNetEvent('qb-clothes:client:NewCharacter', ChangeToSkinNoUpdate)
RegisterNetEvent('qb-clothes:client:NewCharacterChangeVariation', ChangeVariation)
RegisterNetEvent('qb-clothes:client:NewCharacterSaveSkin', SaveSkin)
